...
class ApiService {
  ...
  static const String _serverIp   = '192.168.137.1';   // PC hotspot IP (device is 192.168.137.104)
  ...
  static String get transportApiBaseUrl => 'http://$_host:$_serverPort/api/transport';
  ...
  Future<Map<String, dynamic>> getReportData(int userId, {String? startDate, String? endDate}) async {
    try {
  ...
  Future<List<Map<String, dynamic>>> getDriverTransportRequests(int userId) async {
    try {
  ...
  Future<bool> markTransportPickedUp(int requestId, {required int driverId, required String driverName, String? notes}) async {
    try {
      final response = await http.post(
  ...
  Future<bool> submitTransportReceipt(int requestId, {
    required int driverId,
    required String driverName,
  ...
  Future<Map<String, dynamic>?> getPrivateCompanyInfo(int userId) async {
    try {
      ...
      return null;
    } catch (e) { print('Get private company info error: $e'); return null; }
  }
  ...
  Future<bool> submitPrivateReceipt({
    ...
    } catch (e) { print('Submit private receipt error: $e'); return false; }
  }
  ...
  Future<List<Map<String, dynamic>>> getPrivateReceipts(int userId) async {
    try {
      ...
      return [];
    } catch (e) { print('Get private receipts error: $e'); return []; }
  }
}
